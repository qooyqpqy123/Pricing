...
for times in range(10):
    ...
    for k in range(epi_num):
        ...
        #print(m)
        l_k1=math.floor((l_k*2)**(13/23)) #when m is unknown l_k1=math.floor((l_k*2)**((2*m+1)/(4*m-1))) #m is chosen via choose_m: in the end
        l_k1_total+=l_k1
        v_i=[]
        v_i_true=[]
        v_t=[]
        ...
        while t<=l_k:
            if t<=l_k1:  
                ...
                reg.append(rev_diff)#revenue difference of our algorithm
                ...
                if t==l_k1:
                    ...
                    ker=Kernel(v_i_explore_true,y_t_explore,l_k1_total,1.2*l_k1_total**(-1/13)) 
                    ker_tt=Kernel(v_i_explore_true,y_t_explore,l_k1_total,1.2*l_k1_total**(-1/13))
                    print('--explore--')
                t=t+1
